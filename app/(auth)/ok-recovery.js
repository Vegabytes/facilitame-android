...
export default function PasswordRecoveryOkScreen() {
  ...
  return (
    <View className="flex flex-1 bg-background justify-center items-center p-4">
      ...
      <Text className="text-lg font-bold text-button text-center">
        Si hay una cuenta de Facilítame asociada a ese correo, te enviaremos por
        email las instrucciones para restablecer tu contraseña,
      </Text>
